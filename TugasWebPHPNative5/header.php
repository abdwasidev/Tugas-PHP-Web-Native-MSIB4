...
<head>
	...
	<link rel="stylesheet" href="homeassets/css/ion.rangeSlider.css" />
	<link rel="stylesheet" href="homeassets/css/ion.rangeSlider.skinFlat.css" />
		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="?url=home"><img src="homeassets/img/logo.png" alt=""></a>
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item"><button class="btn-outline-primary px-4 rounded"><a class="nav-link" href="?url=admin/login">Login</a></button></li>
						</ul>
