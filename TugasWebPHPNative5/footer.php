				...
				<div class="col-lg-3  col-md-6 col-sm-6">
					<div class="single-footer-widget mail-chimp">
						...
						<ul class="instafeed d-flex flex-wrap">
							<li><img src="homeassets/img/i1.jpg" alt=""></li>
							<li><img src="homeassets/img/i2.jpg" alt=""></li>
							<li><img src="homeassets/img/i3.jpg" alt=""></li>
							<li><img src="homeassets/img/i4.jpg" alt=""></li>
							<li><img src="homeassets/img/i5.jpg" alt=""></li>
							<li><img src="homeassets/img/i6.jpg" alt=""></li>
							<li><img src="homeassets/img/i7.jpg" alt=""></li>
							<li><img src="homeassets/img/i8.jpg" alt=""></li>
						</ul>
					</div>
				</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<script src="homeassets/js/countdown.js"></script>
