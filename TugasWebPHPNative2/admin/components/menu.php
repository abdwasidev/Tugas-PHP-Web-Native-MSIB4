    ...
    <div class="nav">
        ...
        >
            ...
            <nav class="sb-sidenav-menu-nested nav">
                ...
                <a class="nav-link" href="./../auth/?url=register">Register</a>
                <a class="nav-link" href="./../auth/?url=password">Forgot Password</a>
            </nav>
            </div>
            <a
            class="nav-link collapsed"
            ...
            >
            <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="error/?url=401">401 Page</a>
                <a class="nav-link" href="error/?url=404">404 Page</a>
                <a class="nav-link" href="error/?url=500">500 Page</a>
            </nav>
            </div>
        </nav>
        </div>
